          ...
          return (
            <button
              ...
              style={{
                ...
                border: isHovered
                  ? '1.5px solid rgb(var(--accent) / 0.5)'
                  : '1px solid rgba(255,255,255,0.08)',
                boxShadow: isHovered
                  ? '0 0 30px rgb(var(--accent) / 0.15), inset 0 1px 0 rgba(255,255,255,0.08)'
            ...
            >
              ...
              <div className="flex-1 flex items-end justify-center overflow-hidden w-full">
                <img
                  ...
                  style={{
                    height: '180px',
                    filter: isHovered
                      ? 'drop-shadow(0 0 20px rgb(var(--accent) / 0.35)) brightness(1.1)'
              ...
              <span
                ...
                style={{
                  color: isHovered ? 'var(--text-primary)' : 'rgb(var(--subtle) / 0.85)',
                }}
              >
                {tile.label}
              </span>
              ...
              <span
                ...
                style={{
                  color: isHovered ? 'rgb(var(--accent) / 0.7)' : 'rgb(var(--muted) / 0.5)',
                }}
              >
                {tile.description}
              </span>
